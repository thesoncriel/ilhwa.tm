...
namespace Artn.Ilhwa.Model
{
	...
	public abstract class AbsDataViewManageable: TreeRecordable, IMultiColumnRecordable
	{
		...
		public void Add(string myKey, string addValue)
		{
			this[myKey] = (Double.Parse(this[myKey]) + Double.Parse(addValue)).ToString();
		}
		
		public void Sub(string myKey, string subValue)
		{
			this[myKey] = (Double.Parse(this[myKey]) - Double.Parse(subValue)).ToString();
		}
	}
}
