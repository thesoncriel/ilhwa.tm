...
namespace Theson.Common
{
    ...
    public interface IMultiColumnRecordable: ITreeData
	{
		...
		IMultiColumnDataView DataView{get;set;}
		
		void Add(string myKey, string addValue);
		void Sub(string myKey, string subValue);
	}
    ...
    public interface ITreeData: IMemberClearable{
    ...
    public interface IMultiColumnDataView: IComponent, IMemberClearable
	{
		bool Visible{ get; set; }
		void Refresh();
		IMultiColumnRecordable ViewData{ get; set; }
		event LogEventHandler LogMessage;
	}
