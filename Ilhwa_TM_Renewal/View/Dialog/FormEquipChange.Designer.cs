...
namespace Artn.Ilhwa.View.TasRegistPart
{
	partial class FormEquipChange
	{
		...
		{
			System.Windows.Forms.ListViewItem listViewItem6 = new System.Windows.Forms.ListViewItem("ddd");
			System.Windows.Forms.ListViewItem listViewItem7 = new System.Windows.Forms.ListViewItem("asdss");
			System.Windows.Forms.ListViewItem listViewItem8 = new System.Windows.Forms.ListViewItem("dfdfdf");
			System.Windows.Forms.ListViewItem listViewItem9 = new System.Windows.Forms.ListViewItem("aaa");
			System.Windows.Forms.ListViewItem listViewItem10 = new System.Windows.Forms.ListViewItem("ㄴㄹㄴㄹㄴㄹ");
			...
			// groupBox_Type
			// 
			this.groupBox_Type.Controls.Add(this.radioButton_TypeB);
			this.groupBox_Type.Controls.Add(this.radioButton_TypeA);
			this.groupBox_Type.Location = new System.Drawing.Point(218, 9);
			this.groupBox_Type.Name = "groupBox_Type";
			this.groupBox_Type.Size = new System.Drawing.Size(309, 81);
			this.groupBox_Type.TabIndex = 10;
			this.groupBox_Type.TabStop = false;
			this.groupBox_Type.Text = "설비 형태";
			// 
			// radioButton_TypeB
			// 
			this.radioButton_TypeB.Font = new System.Drawing.Font("굴림", 15.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(129)));
			this.radioButton_TypeB.Location = new System.Drawing.Point(166, 20);
			this.radioButton_TypeB.Name = "radioButton_TypeB";
			this.radioButton_TypeB.Size = new System.Drawing.Size(116, 47);
			this.radioButton_TypeB.TabIndex = 11;
			this.radioButton_TypeB.Text = "설비호기";
			this.radioButton_TypeB.UseVisualStyleBackColor = true;
			this.radioButton_TypeB.CheckedChanged += new System.EventHandler(this.RadioButton_TypeCheckedChanged);
			// 
			// radioButton_TypeA
			// 
			this.radioButton_TypeA.Checked = true;
			this.radioButton_TypeA.Font = new System.Drawing.Font("굴림", 15.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(129)));
			this.radioButton_TypeA.Location = new System.Drawing.Point(19, 20);
			this.radioButton_TypeA.Name = "radioButton_TypeA";
			this.radioButton_TypeA.Size = new System.Drawing.Size(120, 47);
			this.radioButton_TypeA.TabIndex = 10;
			this.radioButton_TypeA.TabStop = true;
			this.radioButton_TypeA.Text = "조관호기";
			this.radioButton_TypeA.UseVisualStyleBackColor = true;
			this.radioButton_TypeA.CheckedChanged += new System.EventHandler(this.RadioButton_TypeCheckedChanged);
			// 
			// FormEquipChange
			// 
