...
namespace Artn.Ilhwa.Controller
{
	...
	public class DataViewController: DataViewBinder
	{
		...
		private TaskCurrentController _taskCurrentCtrl = null;
		...
		public DataViewController(): base()
		{
			...
			_taskCurrentCtrl = new TaskCurrentController();
			_taskCurrentCtrl.ViewBinder = this;
			_taskCurrentCtrl.LogMessage += OnLogMessage;
		}
		...
		public TaskCurrentController TaskCurrent{
			get{ return _taskCurrentCtrl; }
		}
	}
}
